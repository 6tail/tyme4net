...
public class WeekTest
{
    ...
    public void Test25()
    {
        var week = SolarDay.FromYmd(2024, 7, 1).GetSolarWeek(0);
        Assert.Equal("2024年7月第一周", week.ToString());
        Assert.Equal(26, week.IndexInYear);

        week = week.Next(1);
        Assert.Equal("2024年7月第二周", week.ToString());
    }
}