...
namespace tyme.rabbyung
{
    ...
    public class RabByungMonth : MonthUnit
    {
        ...
        /// 别名
        /// </summary>
        public static string[] Aliases = { "神变月", "苦行月", "具香月", "萨嘎月", "作净月", "明净月", "具醉月", "具贤月", "天降月", "持众月", "庄严月", "满意月" };
        ...
        public static void Validate(int year, int month)
        {
            ...
            {
                throw new ArgumentException($"rab-byung year {year} must between 1950 and 2050");
            }
            ...
            if (year == 1950 && m < 12)
            {
                throw new ArgumentException($"month ${month} must be 12 in rab-byung year {year}");
            }

            if (leap && m != RabByungYear.FromYear(year).LeapMonth)
            {
                throw new ArgumentException($"illegal leap month {m} in rab-byung year {year}");
            }
        }
        ...
        /// 藏历年
        /// </summary>
        public RabByungYear RabByungYear => RabByungYear.FromYear(Year);
        ...
        public int IndexInYear
        {
            get
            {
                ...
                {
                    var leapMonth = RabByungYear.LeapMonth;
        ...
        /// 首日
        /// </summary>
        public RabByungDay FirstDay => new RabByungDay(Year, MonthWithLeap, 1);
